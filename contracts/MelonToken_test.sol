...
contract MelonToken_test is ERC20, SafeMath {
    ...
    uint public constant COMPANY_PERCENT_ALLOCATION = 15; // 15% of token supply allocated post-contribution for the founder allocation
    ...
    function MelonToken_test(address founderInput, address signerInput, uint startBlockInput, uint endBlockInput) {
    ...
    {
        uint tokens = safeMul(msg.value / 1000, testPrice()); // to avoid decimal numbers
